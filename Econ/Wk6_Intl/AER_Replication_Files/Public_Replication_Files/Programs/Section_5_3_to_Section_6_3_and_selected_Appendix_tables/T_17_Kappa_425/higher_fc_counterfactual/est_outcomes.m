function [fc_median_unconditional , share_importers, share_importers_by_country , perc_bracket_1, perc_bracket_2, perc_bracket_3, perc_bracket_4, median_input_purchase, perc90_input_purchase , input_p_mat, price_vec , profit_vec, fc_payments_all, sales_vec, share_importers_cell] = est_outcomes(beta_guess,m)


B_guess                 = beta_guess(1);
fc_mean_guess           = beta_guess(2:5);
fc_disp_guess           = beta_guess(6);
...
fc_mat(:,m.chn_ctr_ind) = fc_mat(:,m.chn_ctr_ind)*m.china_shock_fc;
end
...
share_importers_cell            = cell(4,1);
share_importers_cell{1}         = share_importers_q1;
share_importers_cell{2}         = share_importers_q2;
share_importers_cell{3}         = share_importers_q3;
share_importers_cell{4}         = share_importers_q4;
