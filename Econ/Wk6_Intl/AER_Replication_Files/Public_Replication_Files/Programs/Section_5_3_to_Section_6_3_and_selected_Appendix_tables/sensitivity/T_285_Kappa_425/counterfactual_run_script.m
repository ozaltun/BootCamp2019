...
m.exp_fe_est(chn_ctr_ind)           = m.exp_fe_est(chn_ctr_ind) * 2;   % Increase Chinese Sourcing Potential by 100 percent.
%m.exp_fe_est(chn_ctr_ind)           = m.exp_fe_est(chn_ctr_ind)* 0.16;   % Chinese Sourcing Potential falls.
