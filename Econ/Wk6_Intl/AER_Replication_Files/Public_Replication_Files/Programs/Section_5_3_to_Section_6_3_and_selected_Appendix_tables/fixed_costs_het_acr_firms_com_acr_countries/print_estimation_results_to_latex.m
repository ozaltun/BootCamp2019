...
fc_mean_guess             = beta_hat(2);
fc_disp_guess             = beta_hat(3);
...
fprintf(fileID, '\\hline \n \\hline \n \\end{tabular} \n')
fprintf(fileID, '\\begin{tablenotes}[para] \n')
fprintf(fileID, ' \\footnotesize{\\textit{Notes:} Rank for sourcing potential is calculated such that the highest sourcing potential country has the highest rank.} \n');
fprintf(fileID, '\\end{tablenotes} \n');
fprintf(fileID, '\\end{threeparttable} \n')
fprintf(fileID, '\\end{center} \n \\end{table} \n');
% 
